...
namespace Pulumi.Local-test
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Local-test.version.txt");
    ...
    internal sealed class Local-testResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public Local-testResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
